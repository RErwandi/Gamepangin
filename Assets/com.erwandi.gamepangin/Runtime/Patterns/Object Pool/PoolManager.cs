...
namespace Erwandi.Gamepangin.Patterns
{
    ...
    public class PoolManager : MonoBehaviour
    {
        ...
        [SerializeField] private bool singletonMode = false;
        [SerializeField] private ObjectPool[] pools = new ObjectPool[0];
        ...
        public void AddPool(ObjectPool pool) { AddPool(pool.PoolId, pool); }
