...
{	
	...
	public static class MathHelper
    {
        ...
        public static void Spring(ref float currentValue, float targetValue, ref float velocity, float damping, float frequency, float speed, float deltaTime)
        {
            ...
            velocity = SpringVelocity(currentValue, targetValue, velocity, damping, frequency, deltaTime);
            velocity = MathHelper.Lerp(initialVelocity, velocity, speed, Time.deltaTime);
        ...
        public static void Spring(ref Vector2 currentValue, Vector2 targetValue, ref Vector2 velocity, float damping, float frequency, float speed, float deltaTime)
        {
            ...
            velocity.x = SpringVelocity(currentValue.x, targetValue.x, velocity.x, damping, frequency, deltaTime);
            velocity.y = SpringVelocity(currentValue.y, targetValue.y, velocity.y, damping, frequency, deltaTime);
            velocity.x = MathHelper.Lerp(initialVelocity.x, velocity.x, speed, Time.deltaTime);
            velocity.y = MathHelper.Lerp(initialVelocity.y, velocity.y, speed, Time.deltaTime);
            currentValue += deltaTime * velocity;
        }
        ...
        public static void Spring(ref Vector3 currentValue, Vector3 targetValue, ref Vector3 velocity, float damping, float frequency, float speed, float deltaTime)
        {
            ...
            velocity.x = SpringVelocity(currentValue.x, targetValue.x, velocity.x, damping, frequency, deltaTime);
            velocity.y = SpringVelocity(currentValue.y, targetValue.y, velocity.y, damping, frequency, deltaTime);
            velocity.z = SpringVelocity(currentValue.z, targetValue.z, velocity.z, damping, frequency, deltaTime);
            velocity.x = MathHelper.Lerp(initialVelocity.x, velocity.x, speed, Time.deltaTime);
            velocity.y = MathHelper.Lerp(initialVelocity.y, velocity.y, speed, Time.deltaTime);
            velocity.z = MathHelper.Lerp(initialVelocity.z, velocity.z, speed, Time.deltaTime);
            currentValue += deltaTime * velocity;
        }
        ...
        public static void Spring(ref Vector4 currentValue, Vector4 targetValue, ref Vector4 velocity, float damping, float frequency, float speed, float deltaTime)
        {
            ...
            velocity.y = SpringVelocity(currentValue.y, targetValue.y, velocity.y, damping, frequency, deltaTime);
            velocity.z = SpringVelocity(currentValue.z, targetValue.z, velocity.z, damping, frequency, deltaTime);
            velocity.w = SpringVelocity(currentValue.w, targetValue.w, velocity.w, damping, frequency, deltaTime);
            velocity.x = MathHelper.Lerp(initialVelocity.x, velocity.x, speed, Time.deltaTime);
            velocity.y = MathHelper.Lerp(initialVelocity.y, velocity.y, speed, Time.deltaTime);
            velocity.z = MathHelper.Lerp(initialVelocity.z, velocity.z, speed, Time.deltaTime);
            velocity.w = MathHelper.Lerp(initialVelocity.w, velocity.w, speed, Time.deltaTime);
            currentValue += deltaTime * velocity;
        }
		...
		/// <param name="point">The point to rotate.</param>
		/// <param name="pivot">The pivot's position.</param>
		/// <param name="quaternion">The angle as a Quaternion.</param>
