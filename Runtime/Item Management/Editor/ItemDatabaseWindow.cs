    ...
    public class ItemDatabaseWindow : OdinMenuEditorWindow
    {
        ...
        protected override void OnBeginDrawEditors()
        {
            ...
            SirenixEditorGUI.BeginHorizontalToolbar(toolbarHeight);
            {
                ...
                {
                    ScriptableObjectCreator.ShowDialog<ItemPropertyDefinition>(GamepanginGeneralSettings.Instance.ItemsFolderPath + "/PropertyDefinition");
                }

                if (SirenixEditorGUI.ToolbarButton(new GUIContent("Create Tag")))
                {
                    ScriptableObjectCreator.ShowDialog<ItemTagDefinition>(GamepanginGeneralSettings.Instance.ItemsFolderPath + "/TagDefinition");
                }

                if (SirenixEditorGUI.ToolbarButton(new GUIContent("Create Category")))
                {
                        ScriptableObjectCreator.ShowDialog<ItemCategoryDefinition>(GamepanginGeneralSettings.Instance.ItemsFolderPath + "/CategoryDefinition");
                }
            }
